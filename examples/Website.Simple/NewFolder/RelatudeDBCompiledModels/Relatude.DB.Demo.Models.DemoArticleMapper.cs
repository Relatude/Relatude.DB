...
public sealed class _DemoArticle : Relatude.DB.Nodes.IValueMapper {
    ...
    public Relatude.DB.Datamodels.INodeDataExternal CreateNodeDataFromObject(object obj, Relatude.DB.Nodes.RelatedCollection related) {
        ...
        values.Add(g01e7e657f942ed3263a374e100cefe27, node.Paragraphs);
    ...
    public object NodeDataToObject(Relatude.DB.Datamodels.INodeDataExternal nodeData, Relatude.DB.Nodes.NodeStore store) {
        ...
        { obj.File = nodeData.TryGetValue(gd65cef817660f343fa7cb9591c47239c, out var v) ? ((Relatude.DB.Common.FileValue)v).Copy() : Relatude.DB.Common.FileValue.Empty; }
        {
            if (nodeData.TryGetValue(g01e7e657f942ed3263a374e100cefe27, out var v)) {
                obj.Paragraphs = new Relatude.DB.Nodes.InnerNodes<Relatude.DB.Demo.Models.DemoParagraph>(g01e7e657f942ed3263a374e100cefe27, (Relatude.DB.Datamodels.InnerNodeDataMap<Guid>)v, store.Mapper);
            } else {
                obj.Paragraphs = [];
            }
        }
