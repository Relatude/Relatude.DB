...
// WebAppEmpty.Models namespace (see Models/README.md) and become node types when the app starts.
...
app.MapGet("/api/hello", (RelatudeDBContext ctx) => new {
    Message = "Hello from WebApp.Empty!",
    Utc = DateTime.UtcNow,
