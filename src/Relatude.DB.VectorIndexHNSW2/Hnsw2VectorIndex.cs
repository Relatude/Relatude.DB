...
/// <see cref="Hnsw2VectorIndexOptions.MaxMemoryBytes"/> allows, and in a file behind a small cache
/// when it does not (<see cref="Hnsw2VectorIndexOptions.LowMemoryMode"/>). Same contract and the
/// same durability protocol as the other disk vector indexes.
///
...
/// <see cref="Hnsw2VectorIndexOptions.EfSearch"/> candidates at layer 0, scoring int8 copies of the
...
/// <see cref="Hnsw2VectorIndexOptions.MinVectorsForGraphSearch"/> every search is an exact parallel
...
/// <see cref="Hnsw2VectorIndexOptions.MemTableFlushThresholdBytes"/>). Those rewrites are scattered
...
/// <see cref="Hnsw2VectorIndexOptions.CompactionDeadFraction"/>.</para>
///
...
/// the process.</para>
/// </summary>
public class Hnsw2VectorIndex : ISemanticIndex, IDisposable {
    ...
    public Hnsw2VectorIndex(SetRegister sets, string uniqueKey, string friendlyName, string folderPath,
        AIEngine? ai = null, Hnsw2VectorIndexOptions? options = null, Action<string>? log = null) {
        _sets = sets;
        UniqueKey = uniqueKey;
    ...
    /// <see cref="Hnsw2VectorIndexOptions.MaxMemoryBytes"/>); adjustable at runtime. Raising it takes
    ...
    public long MaxMemoryBytes {
        get => _options.ResolvedMaxMemoryBytes;
        set {
    ...
    /// <summary>Search effort as a fraction of <see cref="Hnsw2VectorIndexOptions.EfSearch"/>, see
    /// <see cref="Hnsw2VectorIndexOptions.Accuracy"/>.</summary>
