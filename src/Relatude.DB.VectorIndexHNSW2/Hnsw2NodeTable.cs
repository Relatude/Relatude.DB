...
/// adjacency is mirrored in memory too, unless the index runs with the graph on disk
/// (<see cref="Hnsw2VectorIndexOptions.LowMemoryMode"/>), where it is read from its file per hop and
