...
public class NodeAction : ActionBase {
    public static NodeAction InsertOrFail(INodeDataExternal node) => new(NodeOperation.InsertOrFail, node);
    public static NodeAction InsertIfNotExists(INodeDataExternal node) => new(NodeOperation.InsertIfNotExists, node);
    ...
    public static NodeAction UpdateIfExists(INodeDataExternal node) => new(NodeOperation.UpdateIfExists, node);
    public static NodeAction UpdateOrFail(INodeDataExternal node) => new(NodeOperation.UpdateOrFail, node);
    public static NodeAction ForceUpdate(INodeDataExternal node) => new(NodeOperation.ForceUpdate, node);
    public static NodeAction Upsert(INodeDataExternal node) => new(NodeOperation.Upsert, node);
    public static NodeAction ForceUpsert(INodeDataExternal node) => new(NodeOperation.ForceUpsert, node);
    ...
    public static NodeAction Load(NodeOperation operation, INodeDataExternal node) => new NodeAction(operation, node);
    ...
    private NodeAction(NodeOperation operation, INodeDataExternal node)
