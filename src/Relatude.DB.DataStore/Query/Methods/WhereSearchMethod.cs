...
public class WhereSearchMethod : IExpression {
    ...
    public WhereSearchMethod(IExpression input, string searchText, double? ratioSemantic, float? minimumVectorSimilarity, bool? orSearch, int? maxWordVariations) {
        _input = input;
    ...
    public object Evaluate(IVariables vars) {
        ...
        return searchCollection.FilterBySearch(_searchText, searchProperty, _ratioSemantic, _minimumVectorSimilarity, _orSearch, _maxWordVariations);
    }
}
