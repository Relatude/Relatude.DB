...
public class ObjectData {
    ...
    object? convertIfNeeded(object? v, Func<INodeDataExternal, object?> convertNodeData) {
    ...
    public Tuple<string, object?>[] GetValues(Func<INodeDataExternal, object?> convertNodeData) {
