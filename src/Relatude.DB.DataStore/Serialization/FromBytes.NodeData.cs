...
public static partial class FromBytes {
    ...
    static object toPropertyValue(byte[] bytes, PropertyType propType, Datamodel datamodel, PropertyModel propDef, NodePath parent) {
        return propType switch {
            ...
            PropertyType.DateTimeOffset => DateTimeOffsetPropertyModel.GetValue(bytes),
            ...
            PropertyType.GuidArray => GuidArrayPropertyModel.GetValue(bytes),
            PropertyType.References => GuidArrayPropertyModel.GetValue(bytes),
            PropertyType.EnumArray => EnumArrayPropertyModel.GetValue(bytes),
            PropertyType.GeoCoordinate => GeoCoordinatePropertyModel.GetValue(bytes),
    ...
    static object? forceValueType(PropertyType valueType, object value) {
        ...
        return valueType switch {
            ...
            PropertyType.GuidArray => GuidArrayPropertyModel.ForceValueType(value, out _),
            PropertyType.References => GuidArrayPropertyModel.ForceValueType(value, out _),
            PropertyType.EnumArray => EnumArrayPropertyModel.ForceValueType(value, out _),
            ...
            PropertyType.GeoCoordinate => GeoCoordinatePropertyModel.ForceValueType(value, out _),
