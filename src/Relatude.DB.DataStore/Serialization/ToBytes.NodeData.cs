...
public static partial class ToBytes {
    ...
    static byte[] serializePropertyValue(object value, PropertyType propType, Datamodel datamodel) {
        return propType switch {
            ...
            PropertyType.DateTimeOffset => DateTimeOffsetPropertyModel.GetBytes((DateTimeOffset)value),
            ...
            PropertyType.GeoCoordinate => GeoCoordinatePropertyModel.GetBytes((GeoCoordinate)value),
