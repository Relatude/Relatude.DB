...
// asks about one folder and nobody means to walk a tree by clicking through it. "Thumbnails" draws
// the same files as pictures instead of rows - a scaled down copy from the server for an image, a
// frame for a video, its type icon for everything else.
//
