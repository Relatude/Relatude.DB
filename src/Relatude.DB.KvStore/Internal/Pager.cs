...
internal sealed class Pager : IPageSource, IDisposable
{
    ...
    public Pager(string path, long cacheBytes)
    {
        ...
        _flushStream = new FileStream(_handle, FileAccess.ReadWrite, bufferSize: 1);
    ...
    /// <summary>Bytes currently used by the database file.</summary>
    public long FileLength => RandomAccess.GetLength(_handle);
