...
public static class ModelGen {
    /// <summary>
    /// The first line of a generated model file: the .NET convention for generated code, which also
    /// keeps analyzers off the file. A file that starts with it (after whitespace or a byte order mark)
    /// is one the datamodel editor may delete and generate again without asking.
    /// </summary>
    public const string AutoGeneratedMarker = "// <auto-generated>";
    /// <summary>
    /// The comment a generated model file starts with, saying that it is generated and will be
    /// overwritten. <paramref name="sourceName"/> names the datamodel source the file belongs to.
    /// </summary>
    public static string AutoGeneratedHeader(string? sourceName = null) {
        var sb = new StringBuilder();
        sb.AppendLine(AutoGeneratedMarker);
        sb.AppendLine("//     This file was generated by Relatude.DB from the data model" + (string.IsNullOrEmpty(sourceName) ? "" : " (source \"" + sourceName + "\")") + ".");
        sb.AppendLine("//     Do not edit it. Every file in this folder is deleted and generated again each time the data");
        sb.AppendLine("//     model is activated, so any change made here is lost then. Change the model in the data model");
        sb.AppendLine("//     editor instead.");
        sb.AppendLine("// </auto-generated>");
        sb.AppendLine();
        return sb.ToString();
    }
    /// <summary>Whether the text is a file generated by the datamodel editor (or another tool following the same convention).</summary>
    public static bool IsAutoGenerated(string text) => text.TrimStart('\uFEFF', ' ', '\t', '\r', '\n').StartsWith(AutoGeneratedMarker, StringComparison.Ordinal);
