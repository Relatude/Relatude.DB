...
public static class GlobalExtensions {
    public static IEndpointRouteBuilder UseWAFDB(this WebApplication app, string? urlPath = "/relatude.db", 
    ...
    public static Task<IEndpointRouteBuilder> UseWAFDBAsync(this WebApplication app, string? urlPath = "/relatude.db",
    string? dataFolderPath = null, string? tempFolderPath = null, ISettingsLoader? settingsIO = null) {
