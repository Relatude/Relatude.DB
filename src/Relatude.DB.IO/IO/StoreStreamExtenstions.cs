...
public static class StoreStreamExtenstions {
    ...
    // reused per thread; Append copies before returning
    [ThreadStatic] static byte[]? _scratch;
    static byte[] scratch => _scratch ??= new byte[16];


    public static void WriteVerifiedInt(this IAppendStream s, int v) {
        var b = scratch;
        BitConverter.TryWriteBytes(b, v); s.Append(b, 4);
        BitConverter.TryWriteBytes(b, -v); s.Append(b, 4);
    }
    ...
    public static void WriteVerifiedLong(this IAppendStream s, long v) {
        var b = scratch;
        BitConverter.TryWriteBytes(b, v); s.Append(b, 8);
        BitConverter.TryWriteBytes(b, -v); s.Append(b, 8);
    }
    ...
    public static void WriteBool(this IAppendStream s, bool v) {
        ...
        var b = scratch; b[0] = (byte)(v ? 1 : 0); s.Append(b, 1);
    }
    ...
    public static void WriteOneByte(this IAppendStream s, byte v) {
        var b = scratch; b[0] = v; s.Append(b, 1);
    }
    ...
    public static void WriteUInt(this IAppendStream s, uint v) {
        var b = scratch; BitConverter.TryWriteBytes(b, v); s.Append(b, 4);
    }
    ...
    public static void WriteLong(this IAppendStream s, long v) {
        var b = scratch; BitConverter.TryWriteBytes(b, v); s.Append(b, 8);
    }
    ...
    public static void WriteChar(this IAppendStream s, char v) {
        var b = scratch; BitConverter.TryWriteBytes(b, v); s.Append(b, 2);
    }
    ...
    public static void WriteDateTimeUtc(this IAppendStream s, DateTime v) {
        var b = scratch; BitConverter.TryWriteBytes(b, v.Ticks); s.Append(b, 8);
    }
    ...
    public static void WriteDateTimeOffset(this IAppendStream s, DateTimeOffset v) {
        ...
        var buf = scratch;
        BinaryPrimitives.WriteInt64LittleEndian(buf.AsSpan(0, 8), utcTicks);
        BinaryPrimitives.WriteInt16LittleEndian(buf.AsSpan(8, 2), offsetMinutes);
        s.Append(buf, 10);
    }
    ...
    public static void WriteGuid(this IAppendStream s, Guid v) {
        var b = scratch; v.TryWriteBytes(b); s.Append(b, 16);
    }
